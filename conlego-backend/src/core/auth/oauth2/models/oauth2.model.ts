...
import { OAuthTokenModel, IOAuthToken } from './oauth-token.model';
import { OAuthClientModel, IOAuthClient } from './oauth-client.model';
import { OAuthCodeModel, IOAuthCode } from './oauth-authorization-code.model';


export class Oauth2Model
  implements PasswordModel, RefreshTokenModel, ClientCredentialsModel, AuthorizationCodeModel {
  ...
  //#region Authorization code methods
  ...
  //#endregion Authorization code methods
  // ------------------------------------------
